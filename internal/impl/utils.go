...
type TransactOptsFn func(m *{{ .PBPackage | formatPackage }}TransactOpts) *bind.TransactOpts

// DefaultTransactOptsFn
func DefaultTransactOptsFn(m *{{ .PBPackage | formatPackage }}TransactOpts) *bind.TransactOpts {
...
func (c *Utils) Write(filepath, filename string) {
	implTemplate, err := template.New("utils").Funcs(template.FuncMap{
